...
|:---|:---|
|팀명|그린나래|
|프로젝트명|<H3>Open ai 기반 LLM과 Hybrid Recommender System을 통한 미디어(책, 영화, 드라마) 추천 및 공유 플랫폼: 나만의 명대사 기반 미디어 추천 시스템</H3>|
|서비스명|문장의 온도|
|키워드|NLP, DB, OCR, Hybrid Recommender System, LLM, open ai |
|만들고자 하는 것|사용자가 스크린샷이나 사진 촬영을 통해 자신이 좋아하는 문장을 저장하면, 자연어 처리와 gpt를 통해 문장을 분석하여 비슷한 분위기의 명대사와 작품을 추천해주고, 다른 유저들과 공유할 수 있게 하는 서비스|
|타겟고객|- 고객: 한 문장으로 새로운 작품을 접해보고 싶은 사람, 개인 맞춤 미디어 추천 기능이 필요한 사람, 내가 본 책, 영화, 드라마 작품들을 기록하고 싶은 사람.<br>- 페르소나: 지은은 책 읽는 것과 영화 감상에 큰 관심이 있는 29세 직장인이다. 하루하루 바쁜 일정 속에서도 새로운 콘텐츠를 접하며 영감을 받는 것을 좋아한다. 최근 그녀는 자신이 경험한 콘텐츠의 인상깊은 문장들을 기록하고, 이를 통해 비슷한 감성의 새로운 작품을 발견하고 싶어한다. 그러나 시간이 부족해 효율적으로 작품을 선택하기 어려운 상황에서, 지은은 개인 맞춤형 미디어 추천 기능이 탑재된 앱을 발견한다. 이 앱은 그녀가 좋아하는 문장을 기반으로 취향에 맞는 책이나 영화, 드라마를 추천해 줌으로써 그녀의 미디어 소비를 더욱 풍부하고 만족스럽게 만들어 줄 것이다.|
...
|만들고자 하는 것|체형과 스타일이 비슷한 세터와 시커를 매치한 후 시커가 평소 활용하지 못한 옷들을 저장한 옷장에서 입고자 하는 아이템을 고르면 AI모델이 특정 아이템에 대한 모델샷 리뷰 중 가장 보편적인 착장을 분석하여 세터에게 코디 후보를 제공하고 세터는 그 중 자신의 감각으로 셀렉하여 시커에게 코디를 어드바이스 해주는 iOS 어플|
